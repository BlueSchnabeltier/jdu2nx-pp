import os, json, requests, zipfile, subprocess, shutil, json
from jdh import JDHClient
from random import randint

print('''Welcome to JDU2NX++
This is a modification to the automodder of c0llydoll/Just-Dance-UbiArt-Nx-Automodder, which fixes problems and automates the parts of modding that weren't already automated.\n''')

# Ask for codename
name = input("> Codename > ")
config = json.load(open("config.json"))
client = JDHClient(config["token"], config["guild_id"], config["channel_id"])
...
try:
    ...
    print("[ERROR] Please only enter numbers! Exiting...")
    exit()
...
<root>
    ...
    print("[ERROR] An error occured while generating the mainscene! (this is typical, don't freak out)")
...
try:
    ...
    mainscene = skupackages[mainscene_name]['url'].replace("https://jd-s3.akamaized.net/", "https://jd-s3.cdn.ubi.com/")
    r = requests.get(mainscene, allow_redirects=True)
    open(local_path2 + "/" + name + '_mapContent.zip', 'wb').write(r.content)
    print("[INFO]  The mainscene was downloaded")
    
except KeyError:
    print("[INFO]  The mainscene does not exist in sku-packages.json")
    print("[ERROR] Please make sure your codename is correct!")
    exit()
try:
    ...
    print("[INFO]  The coach 1 was downloaded")
    
except KeyError:
    print("[INFO]  The coach 1 does not exist in the sku-packages")
try:
    ...
    print("[INFO]  The coach 2 was downloaded")
    
except KeyError:
    print("[INFO]  The coach 2 texture does not exist in the songdb")
try:
    ...
    print("[INFO]  The coach 3 was downloaded")
    
except KeyError:
    print("[INFO]  The coach 3 texture does not exist in the songdb")
try:
    ...
    print("[INFO]  The coach 4 was downloaded")
    
except KeyError:
    print("[INFO]  The coach 4 texture does not exist in the songdb")
try:
    ...
    print("[INFO]  The generic cover was downloaded")
    
except KeyError:
    print("[INFO]  The generic cover does not exist in the songdb")
try:
    ...
    print("[INFO]  The online cover was downloaded")
    
except KeyError:
    print("[INFO]  The online cover does not exist in the songdb")
try:
    ...
    print("[INFO]  The album coach was downloaded")
    
except KeyError:
    print("[INFO]  The album does not exist in the songdb")
try:
    ...
    print("[INFO]  The map background was downloaded")
    
except KeyError:
    print("[INFO]  The map background does not exist in the songdb")
...
with zipfile.ZipFile(local_path2 + '/' + name + "_mapContent.zip","r") as zip_ref:
    ...
    print("[INFO]  The .ipk was extracted from the .zip")
...
try:
    ...
    print("[ERROR] The .ipk could not be unpacked! Error: " + KeyError)
...
shutil.rmtree("temp")
print("[INFO]  Done converting your map!")
